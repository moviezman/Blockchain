...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <asp:TextBox ID="txtbx_OudWw" runat="server" TextMode="Password" CssClass="InvulBox"></asp:TextBox><br />
            <h2>Nieuw Wachtwoord:</h2>
            <asp:TextBox ID="txtbx_NieuwWw1" runat="server" TextMode="Password" CssClass="InvulBox"></asp:TextBox><br />
            <h2>Nieuw Wachtwoord Herhalen:</h2>
            <asp:TextBox ID="txtbx_NieuwWw2" runat="server" TextMode="Password" CssClass="InvulBox"></asp:TextBox><br />
